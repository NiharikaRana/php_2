...
<head>
    ...
    <title>Acessories Collection</title>
...
<body class="bg-light">
    <header>
        ...
        <h2> <img src="Images/life.jpeg" height="50px" width="50px" > Matching Acessories</h2>
        <nav class="navi">
            ...
            <a href="login.php#services">Services</a>
            <a href="login.php#contact">Contact</a>
        ...
        <div class="popup">
            <form method="POST" action="login_register.php" onsubmit="return validateLoginForm()">
                <h2>
                    ...
                    <button type="reset" onclick="popup('login_popup')"><i class="full"></i></button>
                </h2>
                <div class="input">
                <i class="envelope"></i>
    ...
    <div class="container" id="admin_popup">
        <div class="admin">
            <form method="POST" action="login_register.php" onsubmit="return validateAdminForm()">
                <h2>
                    <span>ADMIN LOGIN</span>
                    <button type="reset" onclick="popup('admin_popup')"><i class="full"></i></button>
                </h2>
                <div class="input">
                <i class="envelope"></i>
                <input type="text" placeholder="Email or Username" name="email_username" required>
        ...
        <div class="register">
            <form method="POST" action="login_register.php" onsubmit="return validateForm()">
                <h2>
                    ...
                    <button type="reset" onclick="popup('register')"><i class="full"></i></button>
                </h2>
                <div class="input">
                <i class="lines"></i>
    ...
    <script>
        ...
        function validateForm() {
            ...
            // Validate password
            if (password.length < 5 || !password.match(/[^\w\s]/)) {
                alert("Password must have at least 5 characters and must have  at least one special character.");
                return false;
            }
